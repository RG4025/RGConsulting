  ...
  return (
    <>
      <section
        ...
        className=" pb-1 pb-sm-5 main_contact"
      >
          ...
          <div className="container" style={{ margin: "0 auto" }}>
            ...
            <div className="row mt-3 pb-5">
              ...
              <div className="col-12 col-sm-3 mt-4">
                <button type="submit" className="btnSubmit" onClick={getAlert}>
                  Submit
                </button>
              </div>
            </div>
